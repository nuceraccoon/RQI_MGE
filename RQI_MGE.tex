...
\begin{table}[h]
  \caption{
    PWR-900 Comparison of PI and RQI with and without preconditioning on 11 energy sets
  }
  \label{tab:PWR all}
  \begin{center}
    \begin{tabular}{ccccccc}\hline\hline
      ...
      %%
      RQI & w1r1v1 & 3   & 45   & 1.25201 $\pm$ 1.13e-2 & 120$^*$ \\
      RQI & w1r2v2 & 5   & 70   & 1.26835 $\pm$ 9.75e-4 & 54.8 \\
      PI  & none   & 149 & 5602 & 1.27553 $\pm$ 4.34e-6 & 612.2 \\
      PI  & w1r2v2 & 86  & 946  & 1.27512 $\pm$ 1.43e-5 & 720$^*$ \\
      \hline
      PI  & none   & 24  & 901  & 1.27203 $\pm$ 1.01e-4 & 92.1$^\dagger$ \\
      PI  & w1r2v2 & 28  & 312  & 1.27261 $\pm$ 8.24e-5 & 250.9$^\dagger$ \\
      \hline\hline
    \end{tabular}\\
...
\begin{table}[h]
  \caption{
    PWR-900 RQI strong scaling w1r2v2 preconditioning
  }
