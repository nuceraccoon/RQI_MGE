...
\subsection{PWR 900}
\label{subsec:PWR}
We next studied a much larger problem that is ``grand challenge'' in scale, a full PWR 900 core \cite{evans2009d}. This problem used 2 $\times$ 2 spatial cells/pin for 17 $\times$ 17 pins/assembly and 289 assemblies (132 reflector, 159 fuel of varying enrichment). This gave 578 $\times$ 578 $\times$ 700 mesh elements (233,858,800 cells) that we broke up over 112 $\times$ 112 $\times$ 10 partitions (12,544 blocks). We used step characteristic, which has 1 unknown/cell; $P_0$ scattering expansion; an $S_{12}$ angular quadrature; and 44 energy groups--all of which gave 1.73 trillion unknowns. We further used a V-cycle depth of 2, a reduced quadrature in MGE of $S_2$, and, unless otherwise noted, tolerances of $1 \times 10^{-3}$. Based on PWR calculations done previously by Evans and Davidson \cite{Evans2010}, $k$ is approximately 1.27. This was solved on Titan. 
