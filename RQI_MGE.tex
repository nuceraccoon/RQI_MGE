...
\begin{table}[!h]
\caption{RQI small test Vacuum Boundaries and Shifted Operator Study}
\begin{center}
\begin{tabular}{| c | c | c | c | c | c | c |}
\hline
W & Relax & V-cycles & \textbf{un}shifted Kry & \textbf{un}shifted RQI & shifted Kry & shifted RQI \\[0.5ex]
\hline
0    & 0 & 0 & 39 & 6 & 39 & 6 \\
1    & 1 & 1 & 27 & 6 & 20 & 6$^{*}$ \\
...
This study exhibited the same patterns for weight, number of relaxations per level, and number of V-cycles as the previously-published MGE results--demonstrating that RQI did not change the parameter behavior.
