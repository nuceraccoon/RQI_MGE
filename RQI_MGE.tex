...
We needed to study multiset scaling for a problem of this size with updated method, and we wanted to compare performance to Arnoldo. This, the BW1484 problem was solved with RQI with and without preconditioning and compared to Arnoldi iteration with both upscatter and regular partitioning. 

We started by performing a smaller study on a local cluster, Remus.  
WHAT ARE THE REMUS DECOMP / DISCRETIZATION / TOLERANCE / MGE / ETC PARAMETERS? 
